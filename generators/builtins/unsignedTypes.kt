...
internal constructor(
     ...
     * Progression with positive step is empty if its first element is greater than the last element.
     * Progression with negative step is empty if its first element is less than the last element.
     */
