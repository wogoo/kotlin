 ...
 *
 * This implementation should be used staring with Gradle 5.6.
 */
internal class GradleCompilerRunnerWithGradle56Workers(
    ...
    companion object {
        internal fun shouldBeUsedWithCurrentGradleVersion(project: Project): Boolean =
            GradleVersion.version(project.gradle.gradleVersion) >= GradleVersion.version("5.6")
    }
}