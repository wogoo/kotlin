...
class DurationTest {
    ...
    fun construction() {
        ...
        repeat(1000) {
            ...
            val duration = Duration.nanoseconds(nanos)
        ...
        assertTrue(Duration.seconds(PI).isDouble())
        assertTrue((150 * Duration.days(365)).isDouble())
    ...
    @Test
    fun comparisons() {
        val d1 = Duration.days(1000) + Duration.nanoseconds(1)
        val d2 = d1 + Duration.nanoseconds(1)
        assertNotEquals(d1, d2)
        assertTrue(d1 < d2)
        assertFalse(d2 < d1)

        val d3 = d1 + Duration.nanoseconds(1.5)
    ...
    fun addition() {
        ...
        assertEquals(Duration.nanoseconds(1.125), Duration.nanoseconds(1) + Duration.nanoseconds(0.125))

        val year = Duration.days(365)
        assertEquals(Duration.nanoseconds(1), 100 * year + Duration.nanoseconds(1) - 100 * year, "no rounding in long range")
        assertEquals(280 * year, 140 * year + 140 * year, "long overflows to double")
        assertEquals(year * 300, year * 300 + Duration.nanoseconds(1), "double underflow")
    ...
    fun subtraction() {
        ...
        assertEquals(Duration.nanoseconds(0.625), Duration.nanoseconds(1) - Duration.nanoseconds(0.375))
